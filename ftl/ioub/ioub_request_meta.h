...
#ifndef __IOUB_REQUEST_META_H__
#define __IOUB_REQUEST_META_H__
...
public:
	...
	VOID	Initialize(META_REQUEST_STATUS nStatus, UINT32 m_nMetaLPN, VOID* pstMetaEntry, IOTYPE eIOType, METATYPE eMetaType);
	BOOL	Run(VOID);
