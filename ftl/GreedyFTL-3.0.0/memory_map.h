...
#else
	extern char*	DATA_BUFFER_BASE_ADDR;		// dy, i'm not sure what is required size of this ..
#endif
...
#ifdef WIN32
	#define RESERVED_DATA_BUFFER_SIZE				0x300000			// 3MB, 
#endif
...
#else
	extern char* COMPLETE_FLAG_TABLE_ADDR;
#endif
...
#else
	extern char* DATA_BUFFER_MAP_ADDR;
#endif
