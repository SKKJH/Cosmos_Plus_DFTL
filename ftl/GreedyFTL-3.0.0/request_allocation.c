...
FREE_REQUEST_QUEUE freeReqQ;			// dy, Free request queue status
SLICE_REQUEST_QUEUE sliceReqQ;			// dy, RequestQueue information
...
unsigned int blockedReqCnt;				// blocked request count
